...
RequestMetadata = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      domain:
          ...
          questMetadata.allow_missing_ids] is unset or ``false``.  The
          client-defined scope or source of the service call, which
      ...
      session_id:
          Required if [allow_missing_ids][google.cloud.talent.v4beta1.Re
          questMetadata.allow_missing_ids] is unset or ``false``.  A
      ...
      allow_missing_ids:
          ...
          [session_id][google.cloud.talent.v4beta1.RequestMetadata.sessi
          on_id] and
          [user_id][google.cloud.talent.v4beta1.RequestMetadata.user_id]
          isn’t available for some reason. It is highly recommended not
          to set this field and provide accurate
          [domain][google.cloud.talent.v4beta1.RequestMetadata.domain], 
          [session_id][google.cloud.talent.v4beta1.RequestMetadata.sessi
          on_id] and
          [user_id][google.cloud.talent.v4beta1.RequestMetadata.user_id]
...
CustomAttribute = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      string_values:
          ...
          tomAttribute.string_values] or [long_values][google.cloud.tale
          nt.v4beta1.CustomAttribute.long_values] must be specified.
      ...
      long_values:
          ...
          ``long_value``.  Currently at most 1 [long_values][google.clou
          d.talent.v4beta1.CustomAttribute.long_values] is supported.
      filterable:
...
SpellingCorrection = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      corrected_html:
          ...
          words. Corrected words are called out with the “…” html tags.
          For example, the user input query is “software enginear”,
          where the second word, “enginear,” is incorrect. It should be
          “engineer”. When spelling correction is enabled, this value is
          “software engineer”.
  """,
...
CompensationInfo = _reflection.GeneratedProtocolMessageType(
    ...
    Attributes:
        ...
        unit:
            ...
            it.COMPENSATION_UNIT_UNSPECIFIED][google.cloud.talent.v4beta1.
            CompensationInfo.CompensationUnit.COMPENSATION_UNIT_UNSPECIFIE
            D].
        compensation_amount:
        ...
        expected_units_per_year:
            ...
            when [Job.employment_types][google.cloud.talent.v4beta1.Job.em
            ployment_types] is FULLTIME, a default value is inferred based
            on [unit][google.cloud.talent.v4beta1.CompensationInfo.Compens
            ationEntry.unit]. Default values: - HOURLY: 2080 - DAILY: 260
  ...
  Attributes:
      ...
      annualized_base_compensation_range:
          ...
          times [CompensationEntry.expected_units_per_year][google.cloud
          .talent.v4beta1.CompensationInfo.CompensationEntry.expected_un
          its_per_year].  See [CompensationEntry][google.cloud.talent.v4
          beta1.CompensationInfo.CompensationEntry] for explanation on
          compensation annualization.
      annualized_total_compensation_range:
...
BatchOperationMetadata = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      update_time:
          ...
          metadata and the [update_time][google.cloud.talent.v4beta1.Bat
          chOperationMetadata.update_time] is refreshed every minute
