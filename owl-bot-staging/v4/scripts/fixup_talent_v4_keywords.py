...
class talentCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        ...
        'purge_jobs': ('parent', 'filter', 'force', ),
        'search_jobs': ('parent', 'request_metadata', 'search_mode', 'job_query', 'enable_broadening', 'histogram_queries', 'job_view', 'offset', 'max_page_size', 'page_token', 'order_by', 'diversification_level', 'custom_ranking_info', 'enable_debug_info', 'disable_keyword_match', 'keyword_match_mode', 'mendel_debug_input', ),
        'search_jobs_for_alert': ('parent', 'request_metadata', 'search_mode', 'job_query', 'enable_broadening', 'histogram_queries', 'job_view', 'offset', 'max_page_size', 'page_token', 'order_by', 'diversification_level', 'custom_ranking_info', 'enable_debug_info', 'disable_keyword_match', 'keyword_match_mode', 'mendel_debug_input', ),
