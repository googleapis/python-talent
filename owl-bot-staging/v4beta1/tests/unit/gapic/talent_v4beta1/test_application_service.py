...
@pytest.mark.parametrize("client_class", [
    ApplicationServiceClient, ApplicationServiceAsyncClient
])
@mock.patch.object(ApplicationServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ApplicationServiceClient))
@mock.patch.object(ApplicationServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(ApplicationServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (ApplicationServiceClient, transports.ApplicationServiceGrpcTransport, "grpc", grpc_helpers),
    (ApplicationServiceAsyncClient, transports.ApplicationServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
])
...
def test_application_service_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
def test_application_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.talent_v4beta1.services.application_service.transports.ApplicationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_application_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.talent_v4beta1.services.application_service.transports.ApplicationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.ApplicationServiceTransport()
        adc.assert_called_once()
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (ApplicationServiceAsyncClient, transports.ApplicationServiceGrpcAsyncIOTransport),
])
