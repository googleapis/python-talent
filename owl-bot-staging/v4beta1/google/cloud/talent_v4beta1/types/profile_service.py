...
class ListProfilesResponse(proto.Message):
    ...
    profiles = proto.RepeatedField(proto.MESSAGE, number=1,
...
class SearchProfilesRequest(proto.Message):
    ...
    request_metadata = proto.Field(proto.MESSAGE, number=2,
        message=common.RequestMetadata,
    )

    profile_query = proto.Field(proto.MESSAGE, number=3,
    ...
    histogram_queries = proto.RepeatedField(proto.MESSAGE, number=10,
...
class SearchProfilesResponse(proto.Message):
    ...
    spell_correction = proto.Field(proto.MESSAGE, number=2,
    ...
    histogram_query_results = proto.RepeatedField(proto.MESSAGE, number=5,
        message=histogram.HistogramQueryResult,
    )

    summarized_profiles = proto.RepeatedField(proto.MESSAGE, number=6,
...
class SummarizedProfile(proto.Message):
    ...
    summary = proto.Field(proto.MESSAGE, number=2,
        message=gct_profile.Profile,
    )
