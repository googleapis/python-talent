...
class Job(proto.Message):
    ...
    class DerivedInfo(proto.Message):
        ...
        job_categories = proto.RepeatedField(proto.ENUM, number=3,
    ...
    class ProcessingOptions(proto.Message):
        ...
        html_sanitization = proto.Field(proto.ENUM, number=2,
    ...
    application_info = proto.Field(proto.MESSAGE, number=7,
        message=ApplicationInfo,
    )

    job_benefits = proto.RepeatedField(proto.ENUM, number=8,
        enum=common.JobBenefit,
    )

    compensation_info = proto.Field(proto.MESSAGE, number=9,
        message=common.CompensationInfo,
    )

    custom_attributes = proto.MapField(proto.STRING, proto.MESSAGE, number=10,
        message=common.CustomAttribute,
    )

    degree_types = proto.RepeatedField(proto.ENUM, number=11,
        enum=common.DegreeType,
    )

    department = proto.Field(proto.STRING, number=12)

    employment_types = proto.RepeatedField(proto.ENUM, number=13,
    ...
    job_level = proto.Field(proto.ENUM, number=16,
    ...
    posting_region = proto.Field(proto.ENUM, number=20,
        enum=common.PostingRegion,
    )

    visibility = proto.Field(proto.ENUM, number=21,
        enum=common.Visibility,
    )

    job_start_time = proto.Field(proto.MESSAGE, number=22,
        message=timestamp.Timestamp,
    )

    job_end_time = proto.Field(proto.MESSAGE, number=23,
        message=timestamp.Timestamp,
    )

    posting_publish_time = proto.Field(proto.MESSAGE, number=24,
        message=timestamp.Timestamp,
    )

    posting_expire_time = proto.Field(proto.MESSAGE, number=25,
        message=timestamp.Timestamp,
    )

    posting_create_time = proto.Field(proto.MESSAGE, number=26,
        message=timestamp.Timestamp,
    )

    posting_update_time = proto.Field(proto.MESSAGE, number=27,
        message=timestamp.Timestamp,
    )

    company_display_name = proto.Field(proto.STRING, number=28)

    derived_info = proto.Field(proto.MESSAGE, number=29,
        message=DerivedInfo,
    )

    processing_options = proto.Field(proto.MESSAGE, number=30,
