...
class Application(proto.Message):
    ...
    application_date = proto.Field(proto.MESSAGE, number=7,
        message=date.Date,
    )

    stage = proto.Field(proto.ENUM, number=11,
    ...
    interviews = proto.RepeatedField(proto.MESSAGE, number=16,
        message=common.Interview,
    )

    referral = proto.Field(proto.MESSAGE, number=18,
        message=wrappers.BoolValue,
    )

    create_time = proto.Field(proto.MESSAGE, number=19,
        message=timestamp.Timestamp,
    )

    update_time = proto.Field(proto.MESSAGE, number=20,
        message=timestamp.Timestamp,
    )

    outcome_notes = proto.Field(proto.STRING, number=21)

    outcome = proto.Field(proto.ENUM, number=22,
        enum=common.Outcome,
    )

    is_match = proto.Field(proto.MESSAGE, number=28,
        message=wrappers.BoolValue,
    )
