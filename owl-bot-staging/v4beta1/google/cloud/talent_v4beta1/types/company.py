...
class Company(proto.Message):
    ...
    class DerivedInfo(proto.Message):
        ...
        headquarters_location = proto.Field(proto.MESSAGE, number=1,
    ...
    size = proto.Field(proto.ENUM, number=4,
    ...
    keyword_searchable_job_custom_attributes = proto.RepeatedField(proto.STRING, number=11)

    derived_info = proto.Field(proto.MESSAGE, number=12,
        message=DerivedInfo,
    )
